...
- **Xfce versions:** live validation is on Xfce 4.20 only. Other supported
  Xfce versions have no documented live result here. On Xfce 4.16, copied
  desktop launchers can be made executable but cannot receive the newer trusted
  marker; the desktop may show its normal trust confirmation before first
  launch.
