 ...
 * literals captured by .specify/specs/013-refactor-foundation/artifacts/
 * xfconf-keys.txt against silent drift during the structural refactor.
 *
 * The artifact is generated by contracts/xfconf-key-inventory.md and lists
